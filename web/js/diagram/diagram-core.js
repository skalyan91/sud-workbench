...
const TOKEN_STACK='"Noto Sans", "Noto Sans Adlam", "Noto Sans Adlamunjoined", "Noto Sans Anatolianhieroglyphs", "Noto Sans Arabic", "Noto Sans Armenian", "Noto Sans Avestan", "Noto Sans Balinese", "Noto Sans Bamum", "Noto Sans Bassavah", "Noto Sans Batak", "Noto Sans Bengali", "Noto Sans Bhaiksuki", "Noto Sans Brahmi", "Noto Sans Buginese", "Noto Sans Buhid", "Noto Sans Canadianaboriginal", "Noto Sans Carian", "Noto Sans Caucasianalbanian", "Noto Sans Chakma", "Noto Sans Cham", "Noto Sans Cherokee", "Noto Sans Chorasmian", "Noto Sans Coptic", "Noto Sans Cuneiform", "Noto Sans Cypriot", "Noto Sans Cyprominoan", "Noto Sans Deseret", "Noto Sans Devanagari", "Noto Sans Display", "Noto Sans Duployan", "Noto Sans Egyptianhieroglyphs", "Noto Sans Elbasan", "Noto Sans Elymaic", "Noto Sans Ethiopic", "Noto Sans Georgian", "Noto Sans Glagolitic", "Noto Sans Gothic", "Noto Sans Grantha", "Noto Sans Gujarati", "Noto Sans Gunjalagondi", "Noto Sans Gurmukhi", "Noto Sans Hanifirohingya", "Noto Sans Hanunoo", "Noto Sans Hatran", "Noto Sans Hebrew", "Noto Sans Imperialaramaic", "Noto Sans Indicsiyaqnumbers", "Noto Sans Inscriptionalpahlavi", "Noto Sans Inscriptionalparthian", "Noto Sans Javanese", "Noto Sans Kaithi", "Noto Sans Kannada", "Noto Sans Kawi", "Noto Sans Kayahli", "Noto Sans Kharoshthi", "Noto Sans Khmer", "Noto Sans Khojki", "Noto Sans Khudawadi", "Noto Sans Lao", "Noto Sans Laolooped", "Noto Sans Lepcha", "Noto Sans Limbu", "Noto Sans Lineara", "Noto Sans Linearb", "Noto Sans Lisu", "Noto Sans Lycian", "Noto Sans Lydian", "Noto Sans Mahajani", "Noto Sans Malayalam", "Noto Sans Mandaic", "Noto Sans Manichaean", "Noto Sans Marchen", "Noto Sans Masaramgondi", "Noto Sans Math", "Noto Sans Mayannumerals", "Noto Sans Medefaidrin", "Noto Sans Meeteimayek", "Noto Sans Mendekikakui", "Noto Sans Meroitic", "Noto Sans Miao", "Noto Sans Modi", "Noto Sans Mongolian", "Noto Sans Mro", "Noto Sans Multani", "Noto Sans Myanmar", "Noto Sans NKo", "Noto Sans Nabataean", "Noto Sans Nagmundari", "Noto Sans Nandinagari", "Noto Sans Newa", "Noto Sans Newtailue", "Noto Sans Nkounjoined", "Noto Sans Nushu", "Noto Sans Ogham", "Noto Sans Olchiki", "Noto Sans Oldhungarian", "Noto Sans Olditalic", "Noto Sans Oldnortharabian", "Noto Sans Oldpermic", "Noto Sans Oldpersian", "Noto Sans Oldsogdian", "Noto Sans Oldsoutharabian", "Noto Sans Oldturkic", "Noto Sans Oriya", "Noto Sans Osage", "Noto Sans Osmanya", "Noto Sans Pahawhhmong", "Noto Sans Palmyrene", "Noto Sans Paucinhau", "Noto Sans Phagspa", "Noto Sans Phoenician", "Noto Sans Psalterpahlavi", "Noto Sans Rejang", "Noto Sans Runic", "Noto Sans Samaritan", "Noto Sans Saurashtra", "Noto Sans Sharada", "Noto Sans Shavian", "Noto Sans Siddham", "Noto Sans Signwriting", "Noto Sans Sinhala", "Noto Sans Sogdian", "Noto Sans Sorasompeng", "Noto Sans Soyombo", "Noto Sans Sundanese", "Noto Sans Sunuwar", "Noto Sans Sylotinagri", "Noto Sans Symbols", "Noto Sans Symbols2", "Noto Sans Syriac", "Noto Sans Syriaceastern", "Noto Sans Syriacwestern", "Noto Sans Tagalog", "Noto Sans Tagbanwa", "Noto Sans Taile", "Noto Sans Taitham", "Noto Sans Taiviet", "Noto Sans Takri", "Noto Sans Tamil", "Noto Sans Tamilsupplement", "Noto Sans Tangsa", "Noto Sans Telugu", "Noto Sans Thaana", "Noto Sans Thai", "Noto Sans Thailooped", "Noto Sans Tifinagh", "Noto Sans Tirhuta", "Noto Sans Ugaritic", "Noto Sans Vai", "Noto Sans Vithkuqi", "Noto Sans Wancho", "Noto Sans Warangciti", "Noto Sans Yi", "Noto Sans Zanabazarsquare", "PingFang SC", "PingFang TC", "PingFang HK", "Hiragino Sans", "Hiragino Kaku Gothic ProN", "Apple SD Gothic Neo", -apple-system, system-ui, sans-serif';
const MONO_STACK='"Noto Sans Mono", "Noto Sans", "Noto Sans Adlam", "Noto Sans Adlamunjoined", "Noto Sans Anatolianhieroglyphs", "Noto Sans Arabic", "Noto Sans Armenian", "Noto Sans Avestan", "Noto Sans Balinese", "Noto Sans Bamum", "Noto Sans Bassavah", "Noto Sans Batak", "Noto Sans Bengali", "Noto Sans Bhaiksuki", "Noto Sans Brahmi", "Noto Sans Buginese", "Noto Sans Buhid", "Noto Sans Canadianaboriginal", "Noto Sans Carian", "Noto Sans Caucasianalbanian", "Noto Sans Chakma", "Noto Sans Cham", "Noto Sans Cherokee", "Noto Sans Chorasmian", "Noto Sans Coptic", "Noto Sans Cuneiform", "Noto Sans Cypriot", "Noto Sans Cyprominoan", "Noto Sans Deseret", "Noto Sans Devanagari", "Noto Sans Display", "Noto Sans Duployan", "Noto Sans Egyptianhieroglyphs", "Noto Sans Elbasan", "Noto Sans Elymaic", "Noto Sans Ethiopic", "Noto Sans Georgian", "Noto Sans Glagolitic", "Noto Sans Gothic", "Noto Sans Grantha", "Noto Sans Gujarati", "Noto Sans Gunjalagondi", "Noto Sans Gurmukhi", "Noto Sans Hanifirohingya", "Noto Sans Hanunoo", "Noto Sans Hatran", "Noto Sans Hebrew", "Noto Sans Imperialaramaic", "Noto Sans Indicsiyaqnumbers", "Noto Sans Inscriptionalpahlavi", "Noto Sans Inscriptionalparthian", "Noto Sans Javanese", "Noto Sans Kaithi", "Noto Sans Kannada", "Noto Sans Kawi", "Noto Sans Kayahli", "Noto Sans Kharoshthi", "Noto Sans Khmer", "Noto Sans Khojki", "Noto Sans Khudawadi", "Noto Sans Lao", "Noto Sans Laolooped", "Noto Sans Lepcha", "Noto Sans Limbu", "Noto Sans Lineara", "Noto Sans Linearb", "Noto Sans Lisu", "Noto Sans Lycian", "Noto Sans Lydian", "Noto Sans Mahajani", "Noto Sans Malayalam", "Noto Sans Mandaic", "Noto Sans Manichaean", "Noto Sans Marchen", "Noto Sans Masaramgondi", "Noto Sans Math", "Noto Sans Mayannumerals", "Noto Sans Medefaidrin", "Noto Sans Meeteimayek", "Noto Sans Mendekikakui", "Noto Sans Meroitic", "Noto Sans Miao", "Noto Sans Modi", "Noto Sans Mongolian", "Noto Sans Mro", "Noto Sans Multani", "Noto Sans Myanmar", "Noto Sans NKo", "Noto Sans Nabataean", "Noto Sans Nagmundari", "Noto Sans Nandinagari", "Noto Sans Newa", "Noto Sans Newtailue", "Noto Sans Nkounjoined", "Noto Sans Nushu", "Noto Sans Ogham", "Noto Sans Olchiki", "Noto Sans Oldhungarian", "Noto Sans Olditalic", "Noto Sans Oldnortharabian", "Noto Sans Oldpermic", "Noto Sans Oldpersian", "Noto Sans Oldsogdian", "Noto Sans Oldsoutharabian", "Noto Sans Oldturkic", "Noto Sans Oriya", "Noto Sans Osage", "Noto Sans Osmanya", "Noto Sans Pahawhhmong", "Noto Sans Palmyrene", "Noto Sans Paucinhau", "Noto Sans Phagspa", "Noto Sans Phoenician", "Noto Sans Psalterpahlavi", "Noto Sans Rejang", "Noto Sans Runic", "Noto Sans Samaritan", "Noto Sans Saurashtra", "Noto Sans Sharada", "Noto Sans Shavian", "Noto Sans Siddham", "Noto Sans Signwriting", "Noto Sans Sinhala", "Noto Sans Sogdian", "Noto Sans Sorasompeng", "Noto Sans Soyombo", "Noto Sans Sundanese", "Noto Sans Sunuwar", "Noto Sans Sylotinagri", "Noto Sans Symbols", "Noto Sans Symbols2", "Noto Sans Syriac", "Noto Sans Syriaceastern", "Noto Sans Syriacwestern", "Noto Sans Tagalog", "Noto Sans Tagbanwa", "Noto Sans Taile", "Noto Sans Taitham", "Noto Sans Taiviet", "Noto Sans Takri", "Noto Sans Tamil", "Noto Sans Tamilsupplement", "Noto Sans Tangsa", "Noto Sans Telugu", "Noto Sans Thaana", "Noto Sans Thai", "Noto Sans Thailooped", "Noto Sans Tifinagh", "Noto Sans Tirhuta", "Noto Sans Ugaritic", "Noto Sans Vai", "Noto Sans Vithkuqi", "Noto Sans Wancho", "Noto Sans Warangciti", "Noto Sans Yi", "Noto Sans Zanabazarsquare", "PingFang SC", "PingFang TC", "PingFang HK", "Hiragino Sans", "Hiragino Kaku Gothic ProN", "Apple SD Gothic Neo", ui-monospace, "SF Mono", Menlo, monospace';
...
// hand-maintained condition. Seeded to the base here so measurement works before the first refresh (a harness with
// no #doc yet, e.g. this module's own load time).
let LIVE_TOKEN_STACK=TOKEN_STACK, LIVE_MONO_STACK=MONO_STACK;
let WORD_F='15px '+LIVE_TOKEN_STACK, NODE_F='14px '+LIVE_TOKEN_STACK,
    WORD_F_BOLD='640 '+WORD_F, NODE_F_BOLD='640 '+NODE_F,   // the weight .sel USED to bold a selected token's form to — stemma/tree/arcs reserve width to the WIDER of the two so a token's hit/wash box never needs to change size on selection (no reflow-on-select trigger exists for these views, unlike brackets). Selection no longer changes weight at all (see the "selected token text" note in app.css beside .node.sel .node-lbl: the wrapped/HTML views had no such reserve, so the bump shifted and clipped their layout). The reserves are kept rather than removed — they cost a couple of px of slot width and dropping them would re-space every diagram — so this pair now buys headroom, not a bold state
    POS_F='15px '+LIVE_TOKEN_STACK, GRID_F='462 13px '+LIVE_MONO_STACK, HEAD_F='640 9.5px '+LIVE_TOKEN_STACK,   // POS tags: same size + weight (normal, i.e. no weight token here) as the transliteration (TRANS_F) — upright rather than italic; c2sc small-caps do the visual "tag" styling now, not a bumped weight/shrunk size. GRID_F: weight curve @12.65px (matches table.grid's own CSS weight — was unweighted/400, measuring narrower than the grid actually renders)
    TRANS_F='italic 15px '+LIVE_TOKEN_STACK, TRANS_UP_F='15px '+LIVE_TOKEN_STACK, MWT_F=WORD_F,   /* the MWT surface form measures/renders exactly like a normal token form (WORD_F, 15px). TRANS_UP_F: the same row set UPRIGHT — what a Foreign=Yes token's transliteration renders in (see trFont/.frn-up) */
    GRID_ITAL_F='italic 462 13px '+LIVE_MONO_STACK;   // GRID_F's own italic: what a Foreign=Yes token's Form cell renders in (see .tok-ital / gridFormFont), so its width is measured correctly (esp. RTL). Weight curve @12.65px, matching GRID_F
...
let GLOSS_F=weightCurve(13.2)+' 13.2px '+LIVE_TOKEN_STACK, MSEG_F='italic 15px '+LIVE_TOKEN_STACK, MSEG_UP_F='15px '+LIVE_TOKEN_STACK, MGLOSS_F=weightCurve(13.2)+' 13.2px '+LIVE_TOKEN_STACK;   // item 5: MSeg measures at the TOKEN size (15px = WORD_F), not 14px, and at token WEIGHT (no curve bump — see .gloss[data-tier="mseg"]'s literal 400, its size being the reference size itself). MGloss measures at the block-initial sentence size (13.2px = --stext-fs), weighted via weightCurve() so glossSlotW's measured width matches what .gloss/.gloss[data-tier="mgloss"] actually render at
...
/* SIZE. The tie's font size fixes its DEPTH and its stroke weight; its width is set separately, by stretching
   ...
   width varies. */
let GW_TIE_F='26px '+LIVE_TOKEN_STACK;   // reassigned by refreshFontStacks() alongside every other measurement font, so this stays in step with a live scheme override too
