...
],false,false,true);   // false rtlArg → the status-bar menu is always LTR, regardless of the selected sentence's direction. true fit → shrink to the widest row (four short labels don't fill the 224px floor). No separator row: status-bar menus read as one flat list, on request
